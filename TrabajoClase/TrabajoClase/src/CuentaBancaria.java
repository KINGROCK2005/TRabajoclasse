...
public class CuentaBancaria {
    ...
    public CuentaBancaria(String nomCliente2, String email2, int numTelefono2, int i, int saldo2) {
    }
    ...
    public void incrementSaldo(double cantidad){
    ...
    public void sacarSaldo(double cantidad){
